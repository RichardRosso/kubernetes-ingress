...
class TestVirtualServer:
    @pytest.mark.parametrize("backend_setup", [{}], indirect=True)
    def test_responses_after_setup(self, kube_apis, crd_ingress_controller, backend_setup, virtual_server_setup):
